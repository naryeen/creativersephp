                                ...
                                <div class="content-tab padding_top30 padding_bottom30">
                                    ...
                                    <div class="content-inner active">
                                        <div class="ttm-tabs-desc">
                                            <ul>
                                                <li><p>Bring the creativity, talent, and expertise of Bhutan to the international stage.</li>
                                                <li>Bridge the gap between Australian businesses seeking high-quality outsourcing solutions and the vibrant, skilled workforce of Bhutan.</p></li>
                                            </ul>                                        
                                        </div>
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="section-title style2">
                                        <div class="title-header">
                                            <!-- <h3>NEWS CORNER</h3> -->
                                            <h2 class="title">Our 
                                                <strong class="ttm-textcolor-skincolor">Team</strong></h2>
                                        </div>
