...
/*------------------------------------------------------------------------------*/
    ...
    $(".header_search").each(function(){  
        ...
        // $(".header_search_content form").find('.search_results').remove();
...
// Get Inm Touch With Us ....while submiting
...
$(document).ready(function () {
    ...
    $('#subscribe-form').submit(function (e) {
        ...
        $('#popupMessage').text('Creativerse is a premiere Business Process Outsourcing (BPO) company based in the tranquil and culturally rich nation of Bhutan. We are a team of innovators and creative artists committed to delivering exceptional services across the globe, with a primary focus on Australia');
    });
