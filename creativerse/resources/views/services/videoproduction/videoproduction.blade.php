                        ...
                        <div class="col-lg-4 widget-area sidebar-left">
                            <aside class="widget widget-nav-menu">
                                <ul>
                                    ...
                                    <li class="active"><a href="video-production.html">Video Production</a></li>
                                ...
                                <ul>
                                    <li>
                                        <a class="ttm_prettyphoto " title="general-builder" data-rel="prettyPhoto"
                                            rel="prettyPhoto[coregallery]" href="{{asset('asset/images/portfolio/post01.jpg')}}">
                                            <img class="img-fluid" src="{{asset('asset/images/portfolio/portfolio-01-150x150.jpg')}}"
                                                alt=""></a>
                                    </li>
                                    <li>
                                        <a class="ttm_prettyphoto " title="general-builder" data-rel="prettyPhoto"
                                            rel="prettyPhoto[coregallery]" href="{{asset('asset/images/portfolio/post02.jpg')}}">
                                            <img class="img-fluid" src="{{asset('asset/images/portfolio/portfolio-02-150x150.jpg')}}"
                                                alt=""></a>
                                    </li>
                                    <li>
                                        <a class="ttm_prettyphoto " title="general-builder" data-rel="prettyPhoto"
                                            rel="prettyPhoto[coregallery]" href="{{asset('asset/images/portfolio/post03.jpg')}}">
                                            <img class="img-fluid" src="{{asset('asset/images/portfolio/portfolio-03-150x150.jpg')}}"
                                                alt=""></a>
                                    </li>
                                    <li>
                                        <a class="ttm_prettyphoto " title="general-builder" data-rel="prettyPhoto"
                                            rel="prettyPhoto[coregallery]" href="{{asset('asset/images/portfolio/post04.jpg')}}">
                                            <img class="img-fluid" src="{{asset('asset/images/portfolio/portfolio-04-150x150.jpg')}}"
                                                alt=""></a>
                                    </li>
                                    <li>
                                        <a class="ttm_prettyphoto " title="general-builder" data-rel="prettyPhoto"
                                ...
                                <div class="ttm-service-description">
                                    <div class="padding_bottom50">
                                        <div class="ttm_fatured_image-wrapper">
                                            <img class="img-fluid" src="{{asset('assets/images/services/electrical-services.jpg')}}"
                                                alt="services-1">
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="ttm_fatured_image-wrapper">
                                                <img class="img-fluid" src="{{asset('assets/images/services/electrical-services-01.jpg')}}"
                                                    alt="services-1">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="padding_bottom30 padding_top30">
                                        <div class="ttm_fatured_image-wrapper">
                                            <img class="img-fluid" src="{{asset('assets/images/services/electrical-services-02.jpg')}}"
                                                alt="services-1">
                                        </div>
                                    </div>
